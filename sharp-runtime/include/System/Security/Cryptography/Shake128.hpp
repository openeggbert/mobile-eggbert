...
namespace System::Security::Cryptography {
    ...
    /**
     * @brief Computes a SHAKE128 (FIPS 202) extendable-output hash, whose digest length is
     * chosen by the caller rather than fixed like SHA3-256/384/512.
     *
     * C++ counterpart of .NET System.Security.Cryptography.Shake128. Reduced scope: no
     ...
     */
    class Shake128 {
        SharpRuntimeDetail::Keccak::Sponge sponge_{168, 0x1F};
