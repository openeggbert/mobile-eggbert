...
namespace System::IO::Compression {
    ...
    /**
     * @brief Provides methods to decode data compressed in the GZip data format in a
     * streamless, non-allocating, and performant manner.
     *
     * C++ counterpart of .NET System.IO.Compression.GZipDecoder. Internally composes a
     * DeflateDecoder configured for GZip framing (gzip header/trailer).
     *
