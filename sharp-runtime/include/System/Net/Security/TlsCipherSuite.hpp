...
namespace System::Net::Security {
    ...
    /**
     * @brief Defines the cipher suites used to negotiate encryption for a TLS connection.
     *
     * C++ counterpart of .NET System.Net.Security.TlsCipherSuite. Values are the IANA TLS Cipher
     * Suite Registry identifiers (auto-generated list, same as .NET's own T4-generated enum).
     */
