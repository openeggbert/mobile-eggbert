...
protected:
    ...
    ////////
        ...
        private: static constexpr double waitTable[24] =
        {
        ...
        private: static constexpr Def::ButtonGlyph cheatGeste[10] =
        {
...
#if !KNI
        protected: void OnDeactivated(object sender, EventArgs args) override
#else
