...
// (Bgfx backend). See examples/easygl_environmentmapeffect_multilight_test.cpp and
...
class BgfxSkinnedEffectMultiLightTest : public Game
{
...
public:
    BgfxSkinnedEffectMultiLightTest()
    {
...
int main()
{
    BgfxSkinnedEffectMultiLightTest game;
    game.Run();
