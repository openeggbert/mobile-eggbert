...
namespace WindowsPhoneSpeedyBlupi {
    ...
    Decor::Decor(): m_decor{}, m_bigDecor{}, m_balleTraj{}, m_moveTraj{}, m_moveObject{}, m_keyPress(0),
                    m_lastKeyPress(0),
                    m_term(0),
...
void Decor::InitDecor()
         ...
         void Decor::MemorizeDoors(GameData gameData)
        {
         ...
         static string Decor::GetCheatTinyText(Def::ButtonGlyph glyph)
        {
            switch (glyph)
            {
        ...
        void Decor::BlupiStep()
        {
            ...
            {
                if (m_blupiDir == 2 && m_blupiAction != 3 && m_blupiAction != 59 && m_blupiAction != 7 && m_blupiAction != 6 && m_blupiAction != 29 && ((!m_blupiJeep && !m_blupiTank && !m_blupiSkate) || std::abs(m_blupiVitesseX) <= 8.0))
                {
                    if (m_blupiAir)
                    {
                        PlaySound(5, end);
            ...
            if (m_blupiSpeedX > 0.0 && m_blupiFocus)
            {
                if (m_blupiDir == 1 && m_blupiAction != 3 && m_blupiAction != 59 && m_blupiAction != 7 && m_blupiAction != 6 && m_blupiAction != 29 && ((!m_blupiJeep && !m_blupiTank && !m_blupiSkate) || std::abs(m_blupiVitesseX) <= 8.0))
                {
                    if (m_blupiAir)
                    {
                        PlaySound(5, end);
            ...
            if (m_blupiPower && std::abs(m_blupiPos.X - m_blupiPosMagic.X) + std::abs(m_blupiPos.Y - m_blupiPosMagic.Y) >= 40)
            {
                icon = MoveObjectFree();
                if (icon != -1)
                {
            ...
            if (m_blupiShield && std::abs(m_blupiPos.X - m_blupiPosMagic.X) + std::abs(m_blupiPos.Y - m_blupiPosMagic.Y) >= 40)
            {
                icon = MoveObjectFree();
                if (icon != -1)
                {
            ...
            if (m_blupiHide && std::abs(m_blupiPos.X - m_blupiPosMagic.X) + std::abs(m_blupiPos.Y - m_blupiPosMagic.Y) >= 10)
            {
                icon = MoveObjectFree();
                if (icon != -1)
                {
